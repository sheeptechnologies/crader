...
class TestPostgresGraphStorage(unittest.TestCase):
    ...
    def test_ensure_repository_new(self):
        ...
        result_id = self.storage.ensure_repository(url="https://github.com/org/repo", branch="main", name="My Repo")
    ...
    def test_create_snapshot_existing(self):
        ...
        self.mock_cursor.fetchone.return_value = {"id": "existing-snap", "status": "indexing"}
    ...
    def test_save_embeddings(self):
        ...
        batch = [{"id": "node-1", "embedding": [0.1, 0.2]}]
    ...
    def test_get_file_content_range(self):
        ...
        self.mock_cursor.fetchall.return_value = [{"content": "print('hello')\n", "start_line": 0}]
    ...
    def test_prune_snapshot_check(self):
